...
void hton(struct PacketHeader *phdr) {
  phdr->req_handle = hton64(phdr->req_handle);
  phdr->lba = hton64(phdr->lba);
  phdr->lba_count = hton64(phdr->lba_count);
  phdr->opcode = hton64(phdr->opcode);
  phdr->tsc = hton64(phdr->tsc);
}

void ntoh(struct PacketHeader *phdr) {
  phdr->req_handle = ntoh64(phdr->req_handle);
  phdr->lba = ntoh64(phdr->lba);
  phdr->lba_count = ntoh64(phdr->lba_count);
  phdr->opcode = ntoh64(phdr->opcode);
  phdr->tsc = ntoh64(phdr->tsc);
}
